...
export type RecommendationMode = "natural" | "medium" | "signature" | "bold";
export type StyleReference = { id: string; tenantId: string; serviceCategoryId: string; serviceOptionId?: string; title: string; slug: string; referenceType: string; description: string; referenceImages: StyleReferenceImage[]; primaryReferenceImage?: string; visualRules: string[]; generationRules: string[]; promptFragment: string; negativeConstraints: string[]; active: boolean; sortOrder: number; metadata: Record<string, unknown>; createdAt: string; updatedAt: string };
export type StyleReferenceImage = { id: string; styleReferenceId: string; imageUrl: string; altFa: string; altEn: string; isPrimary: boolean; sortOrder: number; active?: boolean };
